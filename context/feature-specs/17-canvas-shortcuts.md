Add a floating control bar for zoom, undo/redo, and open and close project sidebar and AI Assistant tab then wire the same actions to keyboard shortcuts.
...
5. For Project sidebar and AI Assistant tab we already have toggler for both of them. We just need to assign them with shortcut keys so the user can access them using the keyboard itself. 
...
5. Support these shortcuts:
   ...
   - `Cmd/Ctrl + Y` to redo
   - `Option/Alt + a` to open project sidebar
   - `Option/Alt + s` to open AI Assistant 
