...
#1B1745 — deepest indigo/navy (darkest cube + ribbon base) — 24%
#1D2F6A — deep royal blue — 21%
#224F83 — mid steel blue (most common single color) — 24%
#2A729E — ocean blue — 9%
#4394BF — sky blue — 6%
#56D1E3 — light cyan (arrow highlights) — 3%
#1DE0E7 — bright cyan / electric accent (arrowheads, the "pop") — 3%

Neutral metals (the T-spine)

#404956 — dark slate gray
#6D757F — mid gray (metal highlight)

A practical way to map these to a website:

   - For backgrounds, #1B1745 works as a dark hero/section background, with #1D2F6A as a slightly lifted panel or card. For primary actions and links, #224F83 or #2A729E are your workhorse blues. Reserve #1DE0E7 (the electric cyan) as your accent — buttons on hover, active states, highlights, focus rings — since it's the eye-catching color but appears sparingly in the logo, which is exactly how you'd want to use it in UI. #56D1E3 is a softer companion cyan for secondary highlights or gradients. The two grays (#404956, #6D757F) are ideal for body text on light backgrounds, borders, and muted UI chrome.

   - If you want a matching gradient that mirrors the logo's flow, go #1B1745 → #224F83 → #2A729E → #1DE0E7 for hero banners or buttons.
